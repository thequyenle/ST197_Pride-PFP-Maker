...
import com.pfp.pride.core.extensions.loadImageFromFile
...
import com.pfp.pride.databinding.ActivityViewBinding
...
class ViewActivity : BaseActivity<ActivityViewBinding>() {
    ...
    private fun resetMyCreationSelectionMode() {
        ...
        if (myCreationActivity != null) {
            ...
            if (designFragment is com.pfp.pride.ui.my_creation.fragment.MyDesignFragment) {
