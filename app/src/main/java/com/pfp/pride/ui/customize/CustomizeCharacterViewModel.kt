...
import com.pfp.pride.data.model.custom.ItemColorImageModel
...
import com.pfp.pride.data.model.custom.NavigationModel
    ...
    fun checkDataInternet(context: CustomizeCharacterActivity, action: (() -> Unit)) {
        ...
        InternetHelper.checkInternet(context) { result ->
            if (result == HandleState.SUCCESS) {
                ...
                val dialog = com.pfp.pride.dialog.YesNoDialog(
                    context,
                    R.string.no_internet,
                    R.string.please_check_your_internet,
                    isError = true,
                    dialogType = com.pfp.pride.dialog.DialogType.INTERNET
                )
                dialog.show()
                dialog.onYesClick = {
                    dialog.dismiss()
