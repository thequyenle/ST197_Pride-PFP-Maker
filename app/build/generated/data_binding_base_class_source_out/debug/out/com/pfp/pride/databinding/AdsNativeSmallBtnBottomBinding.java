...
public final class AdsNativeSmallBtnBottomBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeSmallBtnBottomBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static AdsNativeSmallBtnBottomBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeSmallBtnBottomBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_small_btn_bottom, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeSmallBtnBottomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeSmallBtnBottomBinding((NativeAdView) rootView, adAdvertiser, adAppIcon,
          adBody, adCallToAction, adHeadline, adUnitContent);
    }
