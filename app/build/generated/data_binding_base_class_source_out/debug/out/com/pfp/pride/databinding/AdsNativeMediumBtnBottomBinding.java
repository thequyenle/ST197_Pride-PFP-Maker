...
public final class AdsNativeMediumBtnBottomBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeMediumBtnBottomBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static AdsNativeMediumBtnBottomBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeMediumBtnBottomBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_medium_btn_bottom, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeMediumBtnBottomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeMediumBtnBottomBinding((NativeAdView) rootView, adAdvertiser, adAppIcon,
          adBody, adCallToAction, adHeadline, adMedia, adUnitContent);
    }
