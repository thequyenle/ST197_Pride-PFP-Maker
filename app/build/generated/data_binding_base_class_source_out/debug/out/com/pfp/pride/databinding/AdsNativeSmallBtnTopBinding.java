...
public final class AdsNativeSmallBtnTopBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeSmallBtnTopBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static AdsNativeSmallBtnTopBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeSmallBtnTopBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_small_btn_top, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeSmallBtnTopBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeSmallBtnTopBinding((NativeAdView) rootView, adAdvertiser, adAppIcon,
