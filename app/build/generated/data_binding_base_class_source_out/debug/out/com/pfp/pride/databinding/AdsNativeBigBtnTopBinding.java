...
public final class AdsNativeBigBtnTopBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeBigBtnTopBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static AdsNativeBigBtnTopBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeBigBtnTopBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_big_btn_top, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeBigBtnTopBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeBigBtnTopBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
          adCallToAction, adHeadline, adMedia, adUnitContent);
    }
