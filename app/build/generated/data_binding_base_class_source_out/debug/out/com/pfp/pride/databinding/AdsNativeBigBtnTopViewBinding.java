...
public final class AdsNativeBigBtnTopViewBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeBigBtnTopViewBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static AdsNativeBigBtnTopViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeBigBtnTopViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_big_btn_top_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeBigBtnTopViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeBigBtnTopViewBinding((NativeAdView) rootView, adAdvertiser, adAppIcon,
