...
public final class AdsNativeBigBtnBottomBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeBigBtnBottomBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static AdsNativeBigBtnBottomBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeBigBtnBottomBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_big_btn_bottom, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeBigBtnBottomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeBigBtnBottomBinding((NativeAdView) rootView, adAdvertiser, adAppIcon,
